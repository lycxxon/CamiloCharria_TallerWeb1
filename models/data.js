...
var data = [
    ...
    {"name":"Lecciones de Hack (Nivel: 1) $20USD", "productType":"educacion", "description":"Enseñaremos simples tareas de hack, como un ataque DDoS (Distributed denial of Service). Se paga la mitad por adelantado y despues el resto.", "img":"/imgs/"},
    {"name":"Lecciones de Hack (Nivel: 2) $20USD", "productType":"educacion", "description":"Nivel 2 de 6", "img":"/imgs/"},
    {"name":"Lecciones de Hack (Nivel: 3) $40USD", "productType":"educacion", "description":"Nivel 3 de 6", "img":"/imgs/"},
    {"name":"Lecciones de Hack (Nivel: 4) $40USD", "productType":"educacion", "description":"Nivel 4 de 6", "img":"/imgs/"},
    {"name":"Lecciones de Hack (Nivel: 5) $60USD", "productType":"educacion", "description":"Nivel 5 de 6", "img":"/imgs/"},
    {"name":"Lecciones de Hack (Nivel: 6) $60USD", "productType":"educacion", "description":"Nivel 6 de 6", "img":"/imgs/"},
    ...
    {"name":"Vault7 (CIA)", "productType":"leaks", "description":"Es una serie de leaks sobre la CIA y los métodos y medios que usan para hackear, monitorizar, controlar e incluso inhabilitar sistemas que van desde teléfonos inteligentes, televisores e incluso implantes dentales.", "img":"/imgs/"},
    {"name":"Invetigacion Alemana BND-NSA", "productType":"leaks", "description":"2.420 documentos que alegan son de la Comisión parlamentaria alemana que investiga el escándalo de espionaje de la NSA.", "img":"/imgs/"},
    {"name":"PlusD", "productType":"leaks", "description":"Más de 500.000 cables diplomáticos enviados por el Departamento de Estado de los Estados Unidos en 1979 durante la presidencia de Jimmy Carter.", "img":"/imgs/"},
    {"name":"Los Archivos de Yemen", "productType":"leaks", "description":"200 correos electrónicos y 300 documentos internos presuntamente de la Embajada de los Estados Unidos en Sana'a, Yemen. Estos archivos parecen proporcionar detalles sobre las operaciones militares de los Estados Unidos en Yemen de 2009 a marzo de 2015.", "img":"/imgs/"},
    {"name":"Podesta emails", "productType":"leaks", "description":"Correos electrónicos de John Podesta, presidente de la campaña presidencial Hillary Clinton de 2016. Los mensajes de correo electrónico proporcionan una idea del funcionamiento interno de la campaña de Clinton.", "img":"/imgs/"},
